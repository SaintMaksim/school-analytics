...
class DatabaseManagerTest {
    ...
    void testSaveAndRetrieveSchools() throws SQLException {
        School testSchool = new School(1, "Test School", "Test County", "KK-08",
                200, 5.0, 0.1, 0.2, 10, 5000.0, 6000.0, 0.5, 0.6, 0.7);
    ...
    void testGetAverageExpenditureInCounties() throws SQLException {
        School school = new School(1, "Test School", "Fresno", "KK-08",
                100, 5.0, 0.1, 0.2, 10, 6000.0, 6000.0, 0.5, 0.6, 0.7);
    ...
    void testGetTopMathSchoolInStudentRanges() throws SQLException {
        School school = new School(1, "Test School", "Test County", "KK-08",
                6000, 5.0, 0.1, 0.2, 10, 5000.0, 6000.0, 0.5, 0.6, 95.0);
        db.saveSchools(List.of(school));
    ...
    void testSaveSchoolsClearsPreviousData() throws SQLException {
        School oldSchool = new School(1, "Old School", "Old County", "KK-08",
                50, 2.0, 0.0, 0.0, 5, 2000.0, 3000.0, 0.1, 0.2, 50.0);
        db.saveSchools(List.of(oldSchool));

        List<DatabaseManager.CountyAvg> before = db.getAverageStudentsByCounty(10);
        assertEquals(1, before.size());

        School newSchool = new School(2, "New School", "New County", "06-12",
                200, 10.0, 0.1, 0.2, 20, 4000.0, 5000.0, 0.3, 0.4, 80.0);
        db.saveSchools(List.of(newSchool));
    ...
    void testGetAverageStudentsByCountyLimit() throws SQLException {
        ...
        for (int i = 1; i <= 15; i++) {
            School school = new School(i, "School " + i, "County " + i, "KK-08",
                    100, 5.0, 0.1, 0.2, 10, 5000.0, 6000.0, 0.5, 0.6, 0.7);
    ...
    void testGetAverageExpenditureInCountiesWithNonExistentCounty() throws SQLException {
        School school = new School(1, "Test School", "Existing County", "KK-08",
                100, 5.0, 0.1, 0.2, 10, 6000.0, 6000.0, 0.5, 0.6, 0.7);
        db.saveSchools(List.of(school));
    ...
    void testGetAverageExpenditureInCountiesWithZeroMatching() throws SQLException {
        School school = new School(1, "Test School", "Fresno", "KK-08",
                100, 5.0, 0.1, 0.2, 10, 5.0, 6000.0, 0.5, 0.6, 0.7);
        db.saveSchools(List.of(school));
    ...
    void testGetTopMathSchoolInStudentRangesNoMatches() throws SQLException {
        School school1 = new School(1, "Small School", "Test County", "KK-08",
                1000, 5.0, 0.1, 0.2, 10, 5000.0, 6000.0, 0.5, 0.6, 95.0);
        School school2 = new School(2, "Large School", "Test County", "KK-08",
                15000, 5.0, 0.1, 0.2, 10, 5000.0, 6000.0, 0.5, 0.6, 98.0);
